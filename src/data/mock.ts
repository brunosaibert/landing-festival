export const MOCK_ARTISTS = [
  ...
  { id: 2, name: 'Alok', image: '/images/alok.jpg', genre: 'Electronic' },
  { id: 3, name: 'Rita Ora', image: '/images/rita-ora.jpg', genre: 'Pop' },
  {
    id: 4,
    name: 'Dream Theater',
    image: '/images/dream-theater.jpg',
    genre: 'Rock',
  },
  { id: 5, name: 'Dua Lipa', image: '/images/dua-lipa.jpg', genre: 'Pop' },
  { id: 6, name: 'Måneskin', image: '/images/maneskin.jpg', genre: 'Rock' },
  { id: 7, name: 'Emicida', image: '/images/emicida.jpg', genre: 'Hip-Hop' },
  { id: 8, name: 'Coldplay', image: '/images/coldplay.jpg', genre: 'Rock' },
  {
    id: 9,
    name: 'Justin Bieber',
  ...
  },
  {
    id: 10,
    name: 'Luísa Sonza',
    image: '/images/luisa-sonza.jpg',
    genre: 'Pop',
  },
  { id: 11, name: 'Djavan', image: '/images/djavan.jpg', genre: 'MPB' },
  { id: 12, name: 'Offspring', image: '/images/offspring.jpg', genre: 'Rock' },
  {
    id: 13,
    name: 'Avril Lavigne',
    image: '/images/avril-lavigne.jpg',
    genre: 'Rock',
  },
  {
    id: 14,
    name: 'Black Pantera',
    image: '/images/black-pantera.jpg',
    genre: 'Metal',
  },
  { id: 15, name: 'Ed Sheeron', image: '/images/ed-sheeron.jpg', genre: 'Pop' },
  {
    id: 16,
    name: 'Iron Maiden',
